    ...
    <div className="bg-gray-100 dark:bg-dark-light p-6 rounded-lg mt-6 transition-colors duration-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          ...
          className={`w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 px-4 rounded-md transition-all duration-200 flex items-center justify-center gap-2 ${
